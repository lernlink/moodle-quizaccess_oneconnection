...
$string['allowedbyon'] = '{$a->time} (Разрешено: {$a->fullname})';
$string['allowchangesinconnection'] = 'Разрешить изменение соединения';
...
$string['defaultenabled_desc'] = 'Если включено, параметр «Блокировать одновременные подключения» будет включен по умолчанию при создании нового теста.';
$string['displayoptions'] = 'Параметры отображения';
$string['downloadcsv'] = 'Экспортировать таблицу в CSV';
$string['downloadexcel'] = 'Экспортировать таблицу в Excel';
...
$string['isadvanced'] = 'Дополнительный параметр';
$string['isadvanced_desc'] = 'Если включено, параметр «Блокировать одновременные подключения» будет отображаться на странице настроек теста только после нажатия кнопки «Показать больше...».';
