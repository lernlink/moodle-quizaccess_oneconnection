...
$string['defaultenabled_desc'] = 'If enabled, the "Block concurrent connections" setting will be checked by default when creating a new quiz.';
$string['displayoptions'] = 'Display options';
$string['downloadcsv'] = 'Export table as CSV';
$string['downloadexcel'] = 'Export table as Excel';
$string['eventattemptblocked'] = 'Student\'s attempt to continue quiz attempt using other connection was blocked';
$string['eventattemptunlocked'] = 'Student was allowed to continue quiz attempt using other connection';
...
$string['isadvanced'] = 'Advanced setting';
$string['isadvanced_desc'] = 'If enabled, the "Block concurrent connections" setting will only be shown on the quiz settings page when "Show more..." is clicked.';
...
$string['pluginname'] = 'Block concurrent connections quiz access rule';
...
$string['settingsintro'] = 'Configure the default behaviour for the “Block concurrent connections quiz access rule. You can pre-enable it for new quizzes and list IP subnets that should be ignored when building the session fingerprint.';
...
$string['studentinfo'] = 'Please note that after starting the quiz attempt any connections to this quiz using other computers or browser sessions will be blocked. Do not close the browser window until the end of the attempt, otherwise the invigilator has to allow a change in connection.';
